...
rec {
  ...
  features_.argon2rs."0.2.5" = deps: f: updateFeatures f (
    rec {
  ...
  features_.arrayvec."0.4.10" = deps: f: updateFeatures f (
    rec {
  ...
  features_.arrayvec."0.4.7" = deps: f: updateFeatures f (
    rec {
      arrayvec = fold recursiveUpdate {} [
  ...
  crates.backtrace."0.3.14" = deps: { features ? (features_.backtrace."0.3.14" deps {}) }: buildRustCrate {
    ...
    ++ (
         if (kernel == "linux" || kernel == "darwin") && !(kernel == "fuchsia") && !(kernel == "emscripten") && !(kernel == "darwin") && !(kernel == "ios") then mapFeatures features (
           []
           ++ (if features.backtrace."0.3.14".backtrace-sys or false then [ (crates.backtrace_sys."${deps."backtrace"."0.3.14".backtrace_sys}" deps) ] else [])
         ) else []
       )
    ++ (
  ...
  features_.backtrace."0.3.14" = deps: f: updateFeatures f (
    rec {
  ...
  crates.backtrace."0.3.9" = deps: { features ? (features_.backtrace."0.3.9" deps {}) }: buildRustCrate {
    ...
    ++ (
         if (kernel == "linux" || kernel == "darwin") && !(kernel == "fuchsia") && !(kernel == "emscripten") && !(kernel == "darwin") && !(kernel == "ios") then mapFeatures features (
           []
           ++ (if features.backtrace."0.3.9".backtrace-sys or false then [ (crates.backtrace_sys."${deps."backtrace"."0.3.9".backtrace_sys}" deps) ] else [])
         ) else []
       )
    ++ (
         if (kernel == "linux" || kernel == "darwin") then mapFeatures features (
    ...
    ++ (
         if kernel == "windows" then mapFeatures features (
           []
           ++ (if features.backtrace."0.3.9".winapi or false then [ (crates.winapi."${deps."backtrace"."0.3.9".winapi}" deps) ] else [])
         ) else []
       )
    ;
    features = mkFeatures (features."backtrace"."0.3.9" or {});
  };
  features_.backtrace."0.3.9" = deps: f: updateFeatures f (
    rec {
      backtrace = fold recursiveUpdate {} [
        {
          "0.3.9".addr2line =
  ...
  features_.blake2_rfc."0.2.18" = deps: f: updateFeatures f (
    rec {
  ...
  features_.cc."1.0.25" = deps: f: updateFeatures f (
    rec {
  ...
  features_.cc."1.0.32" = deps: f: updateFeatures f (
    rec {
      cc = fold recursiveUpdate {} [
        {
          "1.0.32"."rayon" =
  ...
  crates.clap."2.32.0" = deps: { features ? (features_.clap."2.32.0" deps {}) }: buildRustCrate {
    ...
    ++ (
         if !(kernel == "windows") then mapFeatures features (
           []
           ++ (if features.clap."2.32.0".ansi_term or false then [ (crates.ansi_term."${deps."clap"."2.32.0".ansi_term}" deps) ] else [])
         ) else []
       )
    ;
    features = mkFeatures (features."clap"."2.32.0" or {});
  };
  features_.clap."2.32.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.either."1.5.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.either."1.5.1" = deps: f: updateFeatures f (
    rec {
      either = fold recursiveUpdate {} [
        {
          "1.5.1"."use_std" =
  ...
  features_.env_logger."0.5.13" = deps: f: updateFeatures f (
    rec {
  ...
  features_.env_logger."0.6.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.error_chain."0.12.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.failure."0.1.3" = deps: f: updateFeatures f (
    rec {
  ...
  features_.failure."0.1.5" = deps: f: updateFeatures f (
    rec {
  ...
  features_.itertools."0.7.8" = deps: f: updateFeatures f (
    rec {
  ...
  features_.itertools."0.8.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.lazy_static."1.1.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.lazy_static."1.3.0" = deps: f: updateFeatures f (
    rec {
      lazy_static = fold recursiveUpdate {} [
        {
          "1.3.0"."spin" =
  ...
  features_.libc."0.2.43" = deps: f: updateFeatures f (
    rec {
  ...
  features_.libc."0.2.50" = deps: f: updateFeatures f (
    rec {
      libc = fold recursiveUpdate {} [
        {
          "0.2.50"."align" =
  ...
  features_.memchr."1.0.2" = deps: f: updateFeatures f (
    rec {
      libc = fold recursiveUpdate {} [
        {
  ...
  features_.memchr."2.1.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.memchr."2.2.0" = deps: f: updateFeatures f (
    rec {
      memchr = fold recursiveUpdate {} [
        {
          "2.2.0"."use_std" =
  ...
  features_.nodrop."0.1.12" = deps: f: updateFeatures f (
    rec {
  ...
  features_.nom."3.2.1" = deps: f: updateFeatures f (
    rec {
      memchr = fold recursiveUpdate {} [
        {
  ...
  features_.proc_macro2."0.4.20" = deps: f: updateFeatures f (
    rec {
  ...
  features_.proc_macro2."0.4.27" = deps: f: updateFeatures f (
    rec {
      proc_macro2 = fold recursiveUpdate {} [
        {
          "0.4.27"."proc-macro" =
  ...
  features_.quote."0.6.11" = deps: f: updateFeatures f (
    rec {
      proc_macro2 = fold recursiveUpdate {} [
        {
  ...
  features_.quote."0.6.8" = deps: f: updateFeatures f (
    rec {
      proc_macro2 = fold recursiveUpdate {} [
        {
  ...
  crates.rand."0.4.3" = deps: { features ? (features_.rand."0.4.3" deps {}) }: buildRustCrate {
    ...
    ++ (
         if (kernel == "linux" || kernel == "darwin") then mapFeatures features (
           []
           ++ (if features.rand."0.4.3".libc or false then [ (crates.libc."${deps."rand"."0.4.3".libc}" deps) ] else [])
         ) else []
       )
    ++ (
         if kernel == "windows" then mapFeatures features (
  ...
  features_.rand."0.4.3" = deps: f: updateFeatures f (
    rec {
  ...
  crates.rand."0.4.6" = deps: { features ? (features_.rand."0.4.6" deps {}) }: buildRustCrate {
    ...
    ++ (
         if (kernel == "linux" || kernel == "darwin") then mapFeatures features (
           []
           ++ (if features.rand."0.4.6".libc or false then [ (crates.libc."${deps."rand"."0.4.6".libc}" deps) ] else [])
         ) else []
       )
    ++ (
         if kernel == "windows" then mapFeatures features (
  ...
  features_.rand."0.4.6" = deps: f: updateFeatures f (
    rec {
  ...
  features_.rand_core."0.3.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.rand_core."0.4.0" = deps: f: updateFeatures f (
    rec {
      rand_core = fold recursiveUpdate {} [
        {
          "0.4.0"."alloc" =
  ...
  features_.rdrand."0.4.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.regex."1.0.5" = deps: f: updateFeatures f (
    rec {
  ...
  features_.regex."1.1.2" = deps: f: updateFeatures f (
    rec {
  ...
  features_.serde."1.0.80" = deps: f: updateFeatures f (
    rec {
  ...
  features_.serde."1.0.84" = deps: f: updateFeatures f (
    rec {
      serde = fold recursiveUpdate {} [
  ...
  features_.serde."1.0.89" = deps: f: updateFeatures f (
    rec {
      serde = fold recursiveUpdate {} [
        {
          "1.0.89"."serde_derive" =
  ...
  features_.serde_json."1.0.32" = deps: f: updateFeatures f (
    rec {
  ...
  features_.serde_json."1.0.39" = deps: f: updateFeatures f (
    rec {
  ...
  features_.smallvec."0.6.9" = deps: f: updateFeatures f (
    rec {
  ...
  features_.syn."0.15.13" = deps: f: updateFeatures f (
    rec {
      proc_macro2 = fold recursiveUpdate {} [
        {
  ...
  features_.syn."0.15.29" = deps: f: updateFeatures f (
    rec {
      proc_macro2 = fold recursiveUpdate {} [
        {
  ...
  features_.toml."0.5.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.url."1.7.2" = deps: f: updateFeatures f (
    rec {
  ...
  crates.winapi."0.3.6" = deps: { features ? (features_.winapi."0.3.6" deps {}) }: buildRustCrate {
    ...
    build = "build.rs";
    dependencies = (
      if kernel == "i686-pc-windows-gnu" then mapFeatures features (
        [
  ...
  features_.aho_corasick."0.7.3" = deps: f: updateFeatures f (
    rec {
  ...
  crates.backtrace."0.3.15" = deps: { features ? (features_.backtrace."0.3.15" deps {}) }: buildRustCrate {
    ...
    ++ (
         if (kernel == "linux" || kernel == "darwin") && !(kernel == "fuchsia") && !(kernel == "emscripten") && !(kernel == "darwin") && !(kernel == "ios") then mapFeatures features (
           []
           ++ (if features.backtrace."0.3.15".backtrace-sys or false then [ (crates.backtrace_sys."${deps."backtrace"."0.3.15".backtrace_sys}" deps) ] else [])
         ) else []
       )
    ++ (
         if (kernel == "linux" || kernel == "darwin") || abi == "sgx" then mapFeatures features (
  ...
  features_.backtrace."0.3.15" = deps: f: updateFeatures f (
    rec {
  ...
  features_.bstr."0.1.2" = deps: f: updateFeatures f (
    rec {
  ...
  features_.build_const."0.2.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.byteorder."1.3.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.bytes."0.4.12" = deps: f: updateFeatures f (
    rec {
      byteorder = fold recursiveUpdate {} [
        {
  ...
  features_.cargo."0.35.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.cc."1.0.35" = deps: f: updateFeatures f (
    rec {
      cc = fold recursiveUpdate {} [
        {
          "1.0.35"."rayon" =
  ...
  crates.clap."2.33.0" = deps: { features ? (features_.clap."2.33.0" deps {}) }: buildRustCrate {
    ...
    ++ (
         if !(kernel == "windows") then mapFeatures features (
           []
           ++ (if features.clap."2.33.0".ansi_term or false then [ (crates.ansi_term."${deps."clap"."2.33.0".ansi_term}" deps) ] else [])
         ) else []
       )
    ;
    features = mkFeatures (features."clap"."2.33.0" or {});
  };
  features_.clap."2.33.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.commoncrypto."0.2.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.commoncrypto_sys."0.2.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.core_foundation."0.6.4" = deps: f: updateFeatures f (
    rec {
      core_foundation = fold recursiveUpdate {} [
        {
          "0.6.4"."chrono" =
  ...
  features_.crc."1.8.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.crc32fast."1.2.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.crossbeam_utils."0.6.5" = deps: f: updateFeatures f (
    rec {
  ...
  crates.curl."0.4.21" = deps: { features ? (features_.curl."0.4.21" deps {}) }: buildRustCrate {
    ...
    ++ (
         if (kernel == "linux" || kernel == "darwin") && !(kernel == "darwin") then mapFeatures features (
           ...
           ++ (if features.curl."0.4.21".openssl-sys or false then [ (crates.openssl_sys."${deps."curl"."0.4.21".openssl_sys}" deps) ] else [])
         ) else []
       )
    ++ (
  ...
  features_.curl."0.4.21" = deps: f: updateFeatures f (
    rec {
      curl = fold recursiveUpdate {} [
        {
  ...
  crates.curl_sys."0.4.18" = deps: { features ? (features_.curl_sys."0.4.18" deps {}) }: buildRustCrate {
    ...
    ++ (
         if (kernel == "linux" || kernel == "darwin") && !(kernel == "darwin") then mapFeatures features (
           []
           ++ (if features.curl_sys."0.4.18".openssl-sys or false then [ (crates.openssl_sys."${deps."curl_sys"."0.4.18".openssl_sys}" deps) ] else [])
         ) else []
       )
    ++ (
         if abi == "msvc" then mapFeatures features (
  ...
  features_.curl_sys."0.4.18" = deps: f: updateFeatures f (
    rec {
  ...
  features_.either."1.5.2" = deps: f: updateFeatures f (
    rec {
      either = fold recursiveUpdate {} [
        {
          "1.5.2"."use_std" =
  ...
  features_.flate2."1.0.7" = deps: f: updateFeatures f (
    rec {
  ...
  crates.git2."0.8.0" = deps: { features ? (features_.git2."0.8.0" deps {}) }: buildRustCrate {
    ...
    ++ (
         if (kernel == "linux" || kernel == "darwin") && !(kernel == "darwin") then mapFeatures features (
           ...
           ++ (if features.git2."0.8.0".openssl-sys or false then [ (crates.openssl_sys."${deps."git2"."0.8.0".openssl_sys}" deps) ] else [])
         ) else []
       )
    ;
    features = mkFeatures (features."git2"."0.8.0" or {});
  };
  features_.git2."0.8.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.ignore."0.4.7" = deps: f: updateFeatures f (
    rec {
  ...
  features_.itertools."0.7.11" = deps: f: updateFeatures f (
    rec {
  ...
  features_.lazycell."1.2.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.libc."0.2.51" = deps: f: updateFeatures f (
    rec {
      libc = fold recursiveUpdate {} [
        {
          "0.2.51"."align" =
  ...
  crates.libgit2_sys."0.7.11" = deps: { features ? (features_.libgit2_sys."0.7.11" deps {}) }: buildRustCrate {
    ...
    ++ (
         if (kernel == "linux" || kernel == "darwin") then mapFeatures features (
           []
           ++ (if features.libgit2_sys."0.7.11".openssl-sys or false then [ (crates.openssl_sys."${deps."libgit2_sys"."0.7.11".openssl_sys}" deps) ] else [])
         ) else []
       )
    ;
  ...
  features_.libgit2_sys."0.7.11" = deps: f: updateFeatures f (
    rec {
  ...
  features_.miniz_oxide_c_api."0.2.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.ndarray."0.12.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.num_complex."0.2.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.num_traits."0.2.6" = deps: f: updateFeatures f (
    rec {
      num_traits = fold recursiveUpdate {} [
        {
          "0.2.6"."std" =
  ...
  features_.once_cell."0.1.8" = deps: f: updateFeatures f (
    rec {
  ...
  features_.openssl."0.10.20" = deps: f: updateFeatures f (
    rec {
  ...
  features_.openssl_sys."0.9.43" = deps: f: updateFeatures f (
    rec {
  ...
  features_.parking_lot."0.7.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.parking_lot_core."0.4.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.quote."0.6.12" = deps: f: updateFeatures f (
    rec {
      proc_macro2 = fold recursiveUpdate {} [
        {
  ...
  features_.rand."0.6.5" = deps: f: updateFeatures f (
    rec {
  ...
  features_.rand_jitter."0.1.3" = deps: f: updateFeatures f (
    rec {
  ...
  features_.rand_pcg."0.1.2" = deps: f: updateFeatures f (
    rec {
  ...
  features_.rand_xorshift."0.1.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.regex."1.1.6" = deps: f: updateFeatures f (
    rec {
  ...
  features_.rustc_demangle."0.1.14" = deps: f: updateFeatures f (
    rec {
  ...
  features_.serde."1.0.90" = deps: f: updateFeatures f (
    rec {
      serde = fold recursiveUpdate {} [
        {
          "1.0.90"."serde_derive" =
  ...
  features_.syn."0.15.32" = deps: f: updateFeatures f (
    rec {
      proc_macro2 = fold recursiveUpdate {} [
        {
  ...
  features_.tar."0.4.22" = deps: f: updateFeatures f (
    rec {
  ...
  features_.winapi."0.3.7" = deps: f: updateFeatures f (
    rec {
      winapi = fold recursiveUpdate {} [
        {
          "0.3.7"."impl-debug" =
