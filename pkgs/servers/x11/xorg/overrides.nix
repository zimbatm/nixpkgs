...
self: super:
  {
    ...
    imake = super.imake.overrideAttrs (
      attrs: {
        ...
        CFLAGS = [
          ''-DIMAKE_COMPILETIME_CPP='"${if stdenv.isDarwin
        ...
        in
          ...
          // (
               let
                 ...
                 darwinOtherX = overrideDerivation xorgserver (
                   oldAttrs: {
               ...
               in
                 ...
                 then {
                   ...
                   propagatedBuildInputs = [ libpciaccess epoxy ] ++ commonPropagatedBuildInputs
