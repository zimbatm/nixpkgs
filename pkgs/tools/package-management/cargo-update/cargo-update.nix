...
rec {
  ...
  cc_1_0_15_features = f: updateFeatures f (
    rec {
  ...
  clap_2_31_2 = { features ? (clap_2_31_2_features {}) }: clap_2_31_2_ {
    ...
    ++ (
         if !(kernel == "windows") then mapFeatures features (
           []
           ++ (if features.clap_2_31_2.ansi_term or false then [ ansi_term_0_11_0 ] else [])
         ) else []
       )
    ;
    features = mkFeatures (features.clap_2_31_2 or {});
  };
  clap_2_31_2_features = f: updateFeatures f (
    rec {
    ...
    dependencies = mapFeatures features ([ bitflags_0_9_1 libc_0_2_40 libgit2_sys_0_6_19 url_1_7_0 ])
      ++ (
           if (kernel == "linux" || kernel == "darwin") && !(kernel == "darwin") then mapFeatures features (
             ...
             ++ (if features.git2_0_6_11.openssl-sys or false then [ openssl_sys_0_9_30 ] else [])
           ) else []
         )
      ;
    features = mkFeatures (features.git2_0_6_11 or {});
  };
  git2_0_6_11_features = f: updateFeatures f (
    rec {
  ...
  lazy_static_1_0_0_features = f: updateFeatures f (
    rec {
  ...
  libc_0_2_40_features = f: updateFeatures f (
    rec {
  ...
  libgit2_sys_0_6_19 = { features ? (libgit2_sys_0_6_19_features {}) }: libgit2_sys_0_6_19_ {
    ...
    ++ (
         if (kernel == "linux" || kernel == "darwin") then mapFeatures features (
           []
           ++ (if features.libgit2_sys_0_6_19.openssl-sys or false then [ openssl_sys_0_9_30 ] else [])
         ) else []
       )
    ;
  ...
  libgit2_sys_0_6_19_features = f: updateFeatures f (
    rec {
      cc_1_0_15.default = true;
  ...
  memchr_2_0_1_features = f: updateFeatures f (
    rec {
      libc_0_2_40.default = (f.libc_0_2_40.default or false);
      libc_0_2_40.use_std =
        (f.libc_0_2_40.use_std or false)
  ...
  proc_macro2_0_3_8_features = f: updateFeatures f (
    rec {
  ...
  quote_0_5_2_features = f: updateFeatures f (
    rec {
  ...
  rand_0_3_22_features = f: updateFeatures f (
    rec {
  ...
  rand_0_4_2 = { features ? (rand_0_4_2_features {}) }: rand_0_4_2_ {
    dependencies = (if kernel == "fuchsia" then mapFeatures features ([ fuchsia_zircon_0_3_3 ]) else [])
      ++ (
           if (kernel == "linux" || kernel == "darwin") then mapFeatures features (
             []
             ++ (if features.rand_0_4_2.libc or false then [ libc_0_2_40 ] else [])
           ) else []
         )
      ++ (if kernel == "windows" then mapFeatures features ([ winapi_0_3_4 ]) else [])
      ;
  ...
  rand_0_4_2_features = f: updateFeatures f (
    rec {
      fuchsia_zircon_0_3_3.default = true;
      libc_0_2_40.default = true;
  ...
  regex_0_2_11_features = f: updateFeatures f (
    rec {
  ...
  semver_0_9_0_features = f: updateFeatures f (
    rec {
  ...
  serde_1_0_55_features = f: updateFeatures f (
    rec {
  ...
  syn_0_13_10_features = f: updateFeatures f (
    rec {
      proc_macro2_0_3_8.default = (f.proc_macro2_0_3_8.default or false);
      proc_macro2_0_3_8.proc-macro =
        (f.proc_macro2_0_3_8.proc-macro or false)
  ...
  tabwriter_1_0_4_features = f: updateFeatures f (
    rec {
  ...
  unicode_bidi_0_3_4_features = f: updateFeatures f (
    rec {
      matches_0_1_6.default = true;
  ...
  url_1_7_0_features = f: updateFeatures f (
    rec {
  ...
  vec_map_0_8_1_features = f: updateFeatures f (
    rec {
  ...
  void_1_0_2_features = f: updateFeatures f (
    rec {
  ...
  winreg_0_4_0_features = f: updateFeatures f (
    rec {
