...
in
{
  ...
  fetchurl = makeOverridable (import ../build-support/fetchurl) {
    ...
    curl = buildPackages.curl.override (
      old: rec {
  ...
  amuleDaemon = appendToName "daemon" (
    amule.override {
      monolithic = false;
      daemon = true;
    }
  ...
  cabal2nix = haskell.lib.overrideCabal (haskell.lib.generateOptparseApplicativeCompletion "cabal2nix" haskellPackages.cabal2nix) (
    drv: {
      isLibrary = false;
  ...
  stack2nix = with haskell.lib; overrideCabal (justStaticExecutables haskellPackages.stack2nix) (
    drv: {
  ...
  asciidoc-full = appendToName "full" (
    asciidoc.override {
   ...
   */
  graphviz_2_32 = (
    callPackage ../tools/graphics/graphviz/2.32.nix {
      inherit (darwin.apple_sdk.frameworks) ApplicationServices;
    }
  ...
  hdf5-cpp = appendToName "cpp" (
    hdf5.override {
      cpp = true;
    }
  );

  hdf5-fortran = appendToName "fortran" (
    hdf5.override {
      inherit gfortran;
    }
  );

  hdf5-threadsafe = appendToName "threadsafe" (
    hdf5.overrideAttrs (
      oldAttrs: {
        # Threadsafe hdf5
  ...
  netsurf = recurseIntoAttrs (
    let
      callPackage = newScope pkgs.netsurf;
    in
      rec {
  ...
  openssh_hpn = pkgs.appendToName "with-hpn" (
    openssh.override {
      hpnSupport = true;
  ...
  pandoc = haskell.lib.overrideCabal (haskell.lib.justStaticExecutables haskellPackages.pandoc) (
    drv: {
  ...
  stutter = haskell.lib.overrideCabal (haskell.lib.justStaticExecutables haskellPackages.stutter) (
    drv: {
  ...
  bashInteractive_5 = lowPrio (
    callPackage ../shells/bash/5.0.nix {
      interactive = true;
      withDocs = true;
    }
  );
  ...
  gcc49 = lowPrio (
    wrapCC (
      callPackage ../development/compilers/gcc/4.9 {
        inherit noSysDirs;
  ...
  gcc5 = lowPrio (
    wrapCC (
      callPackage ../development/compilers/gcc/5 {
        inherit noSysDirs;
  ...
  gcc6 = lowPrio (
    wrapCC (
      callPackage ../development/compilers/gcc/6 {
        inherit noSysDirs;
  ...
  gcc7 = lowPrio (
    wrapCC (
      callPackage ../development/compilers/gcc/7 {
        inherit noSysDirs;
  ...
  gcc8 = lowPrio (
    wrapCC (
      callPackage ../development/compilers/gcc/8 {
        inherit noSysDirs;
  ...
  gcc9 = lowPrio (
    wrapCC (
      callPackage ../development/compilers/gcc/9 {
        inherit noSysDirs;
  ...
  glslang = callPackage ../development/compilers/glslang {
    spirv-tools = spirv-tools.overrideAttrs (
      _: {
        src = fetchFromGitHub {
          owner = "KhronosGroup";
          repo = "SPIRV-Tools";
    ...
    spirv-headers = spirv-tools.overrideAttrs (
      _: {
        src = fetchFromGitHub {
          owner = "KhronosGroup";
          repo = "SPIRV-Tools";
  ...
  php72Packages = recurseIntoAttrs (
    callPackage ./php-packages.nix {
      php = php72;
    }
  );

  php73Packages = recurseIntoAttrs (
    callPackage ./php-packages.nix {
      php = php73;
    }
  );
  ...
  php72Packages-unit = recurseIntoAttrs (
    callPackage ./php-packages.nix {
      php = php72-unit;
    }
  );

  php73Packages-unit = recurseIntoAttrs (
    callPackage ./php-packages.nix {
      php = php73-unit;
    }
  );
  ...
  libyamlcpp_0_3 = pkgs.libyamlcpp.overrideAttrs (
    oldAttrs: rec {
      src = pkgs.fetchurl {
  ...
  portaudio2014 = portaudio.overrideAttrs (
    oldAttrs: {
      src = fetchurl {
  ...
  leksah = throw (
    "To use leksah, refer to the instructions in "
  ...
  sqlite-replication = sqlite.overrideAttrs (
    oldAttrs: rec {
      name = "sqlite-${version}";
  ...
  sqlcipher = lowPrio (
    callPackage ../development/libraries/sqlcipher {
      readline = null;
      ncurses = null;
    }
  );
  ...
  # Hardened linux
  hardenedLinuxPackagesFor = kernel: linuxPackagesFor (
    kernel.override {
  ...
  systemd_with_lvm2 = pkgs.appendToName "with-lvm2" (
    pkgs.lib.overrideDerivation pkgs.systemd (
      p: {
  ...
  utillinuxMinimal = if stdenv.isLinux then appendToName "minimal" (
    utillinux.override {
      minimal = true;
      ncurses = null;
      perl = null;
  ...
  darcs = haskell.lib.overrideCabal (haskell.lib.justStaticExecutables haskellPackages.darcs) (
    drv: {
  ...
  eclipses = recurseIntoAttrs (
    callPackage ../applications/editors/eclipse {
      jdk = jdk11;
    }
  );
  ...
  emacsPackagesFor = emacs: self: let
    callPackage = newScope self;
  in
    rec {
      inherit emacs;
  ...
  imagemagick7 = lowPrio (
    imagemagick7Big.override {
      ghostscript = null;
    }
  );
  ...
  subversionClient = appendToName "client" (
    pkgs.subversion.override {
      bdbSupport = false;
      perlBindings = true;
      pythonBindings = true;
    }
  ...
  qvim = lowPrio (
    callPackage ../applications/editors/vim/qvim.nix {
  ...
  zeroadPackages = dontRecurseIntoAttrs (
  ...
  deepin = recurseIntoAttrs (
    import ../desktops/deepin {
      inherit pkgs libsForQt5;
      inherit (lib) makeScope;
    }
  );

  enlightenment = recurseIntoAttrs (
    callPackage ../desktops/enlightenment {
  ...
  isabelle = callPackage ../applications/science/logic/isabelle {
    polyml = stdenv.lib.overrideDerivation polyml57 (
      attrs: {
  ...
  root5 = lowPrio (
    callPackage ../applications/science/misc/root/5.nix {
      inherit (darwin.apple_sdk.frameworks) Cocoa OpenGL;
      stdenv = if stdenv.cc.isClang then llvmPackages_5.stdenv else stdenv;
    }
  );
  ...
  ghostscriptX = appendToName "with-X" (
  ...
  */
  ...
  winePackagesFor = wineBuild: lib.makeExtensible (
    self: with self; {
      callPackage = newScope self;
