...
self: super: {
  ...
  dlist = appendPatch (doJailbreak super.dlist) (
    pkgs.fetchpatch {
  ...
  vector-th-unbox = appendPatch super.vector-th-unbox (
    pkgs.fetchpatch {
  ...
  QuickCheck = appendPatch super.QuickCheck (
    pkgs.fetchpatch {
  ...
  regex-base = appendPatch super.regex-base (
    pkgs.fetchpatch {
  ...
  regex-posix = appendPatch super.regex-posix (
    pkgs.fetchpatch {
  ...
  HTTP = appendPatch (doJailbreak super.HTTP) (
    pkgs.fetchpatch {
  ...
  hedgehog = appendPatch super.hedgehog (
    pkgs.fetchpatch {
  ...
  regex-tdfa = appendPatch super.regex-tdfa (
    pkgs.fetchpatch {
  ...
  attoparsec = appendPatch super.attoparsec (
    pkgs.fetchpatch {
  ...
  aeson = appendPatch (dontCheck super.aeson) (
    pkgs.fetchpatch {
      # the test suite breaks the compiler
  ...
  cassava = appendPatch super.cassava (
    pkgs.fetchpatch {
  ...
  lens = appendPatch (doJailbreak super.lens) (
    pkgs.fetchpatch {
