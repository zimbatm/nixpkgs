  ...
  ## GENERAL SETUP BASE PACKAGES
    ...
    in
      ...
      // {
           ...
           entropy = overrideCabal super.entropy (
             old: {
           ...
           fast-logger = overrideCabal super.fast-logger (
             old: {
               postPatch = old.postPatch or ""
                 + ''
           ...
           ghcjs-dom = overrideCabal super.ghcjs-dom (
             drv: {
           ...
           ghcjs-dom-jsffi = overrideCabal super.ghcjs-dom-jsffi (
             drv: {
           ...
           pqueue = overrideCabal super.pqueue (
             drv: {
               postPatch = ''
           ...
           profunctors = overrideCabal super.profunctors (
             drv: {
               preConfigure = ''
           ...
           reflex = overrideCabal super.reflex (
             drv: {
               src = pkgs.fetchFromGitHub {
                 owner = "ryantrinkle";
                 repo = "reflex";
           ...
           reflex-dom = overrideCabal super.reflex-dom (
             drv: {
               src = pkgs.fetchFromGitHub {
                 owner = "ryantrinkle";
                 repo = "reflex-dom";
           ...
           transformers-compat = overrideCabal super.transformers-compat (
             drv: {
               configureFlags = [];
             }
           );
