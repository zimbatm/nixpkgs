...
stdenv.mkDerivation rec {
  ...
  patches = let
    ...
    py37-support = [
      # https://github.com/uber/pyflame/pull/153
      (
        fetchpatch {
      ...
      (
        fetchpatch {
          # "Add python3.7 to travis test matrix"
    ...
    separate-code-support = [
      # https://github.com/uber/pyflame/pull/170
      (
        fetchpatch {
    ...
    full-ptrace-seize-errors = [
      # https://github.com/uber/pyflame/pull/152
      (
        fetchpatch {
          # "Print whole error output from PtraceSeize"
      ...
      (
        fetchpatch {
          # "Print whole error for PtraceSeize"
