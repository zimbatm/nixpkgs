    ...
    rec {
      ...
      update = let
        ...
        */
        ...
        in
          if result.success then result.value else fetchLatest (
            channel
            // {
        ...
        in
          channel
          // lib.optionalAttrs (isNew "i386" "sha256bin32") {
