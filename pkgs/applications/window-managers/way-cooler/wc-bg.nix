...
rec {
  ...
  bitflags_0_9_1_features = f: updateFeatures f (
    rec {
  ...
  clap_2_26_2_features = f: updateFeatures f (
    rec {
  ...
  image_0_10_4 = { features ? (image_0_10_4_features {}) }: image_0_10_4_ {
    dependencies = mapFeatures features (
      [ byteorder_0_5_3 enum_primitive_0_1_1 glob_0_2_11 num_iter_0_1_34 num_rational_0_1_39 num_traits_0_1_40 ]
  ...
  lazy_static_0_2_9_features = f: updateFeatures f (
    rec {
  ...
  libc_0_2_32_features = f: updateFeatures f (
    rec {
  ...
  rand_0_3_17_features = f: updateFeatures f (
    rec {
  ...
  wayland_client_0_9_10_features = f: updateFeatures f (
    rec {
      bitflags_0_9_1.default = true;
      libc_0_2_32.default = true;
  ...
  wayland_sys_0_9_10_features = f: updateFeatures f (
    rec {
