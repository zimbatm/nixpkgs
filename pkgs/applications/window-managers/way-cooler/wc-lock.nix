...
rec {
  ...
  bitflags_0_8_2_features = f: updateFeatures f (
    rec {
  ...
  byteorder_0_5_3_features = f: updateFeatures f (
    rec {
  ...
  byteorder_1_1_0_features = f: updateFeatures f (
    rec {
  ...
  cc_1_0_0_features = f: updateFeatures f (
    rec {
  ...
  clap_2_24_2 = { features ? (clap_2_24_2_features {}) }: clap_2_24_2_ {
    dependencies = mapFeatures features (
      [ bitflags_0_8_2 unicode_segmentation_1_2_0 unicode_width_0_1_4 vec_map_0_8_0 ]
  ...
  clap_2_24_2_features = f: updateFeatures f (
    rec {
  ...
  either_1_2_0_features = f: updateFeatures f (
    rec {
  ...
  error_chain_0_10_0_features = f: updateFeatures f (
    rec {
  ...
  flate2_0_2_20_features = f: updateFeatures f (
    rec {
  ...
  futures_0_1_16_features = f: updateFeatures f (
    rec {
  ...
  gcc_0_3_50_features = f: updateFeatures f (
    rec {
  ...
  gif_0_9_2_features = f: updateFeatures f (
    rec {
  ...
  image_0_10_4 = { features ? (image_0_10_4_features {}) }: image_0_10_4_ {
    dependencies = mapFeatures features (
      [ byteorder_0_5_3 enum_primitive_0_1_1 glob_0_2_11 num_iter_0_1_34 num_rational_0_1_39 num_traits_0_1_37 ]
  ...
  image_0_10_4_features = f: updateFeatures f (
    rec {
  ...
  jpeg_decoder_0_1_13_features = f: updateFeatures f (
    rec {
  ...
  lazy_static_0_2_8_features = f: updateFeatures f (
    rec {
  ...
  libc_0_2_23_features = f: updateFeatures f (
    rec {
  ...
  lzw_0_10_0_features = f: updateFeatures f (
    rec {
  ...
  num_bigint_0_1_40_features = f: updateFeatures f (
    rec {
  ...
  num_rational_0_1_39_features = f: updateFeatures f (
    rec {
  ...
  phf_0_7_21_features = f: updateFeatures f (
    rec {
  ...
  png_0_5_2_features = f: updateFeatures f (
    rec {
  ...
  scopeguard_0_3_2_features = f: updateFeatures f (
    rec {
  ...
  serde_0_9_15_features = f: updateFeatures f (
    rec {
      serde_0_9_15.alloc =
  ...
  serde_json_0_9_10_features = f: updateFeatures f (
    rec {
  ...
  target_build_utils_0_3_1_features = f: updateFeatures f (
    rec {
  ...
  term_size_0_3_0_features = f: updateFeatures f (
    rec {
      kernel32_sys_0_2_2.default = true;
      libc_0_2_23.default = true;
  ...
  toml_0_2_1_features = f: updateFeatures f (
    rec {
  ...
  vec_map_0_8_0_features = f: updateFeatures f (
    rec {
  ...
  wayland_client_0_9_6_features = f: updateFeatures f (
    rec {
      bitflags_0_7_0.default = true;
      libc_0_2_23.default = true;
  ...
  wayland_sys_0_9_6_features = f: updateFeatures f (
    rec {
      dlib_0_3_1.default = true;
      dlib_0_3_1.dlopen =
