...
rec {
  ...
  features_.cairo_rs."0.2.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.cairo_sys_rs."0.4.0" = deps: f: updateFeatures f (
    rec {
      cairo_sys_rs = fold recursiveUpdate {} [
        {
          "0.4.0"."v1_12" =
  ...
  features_.env_logger."0.3.5" = deps: f: updateFeatures f (
    rec {
  ...
  features_.gcc."0.3.55" = deps: f: updateFeatures f (
    rec {
  ...
  features_.gdk_pixbuf."0.2.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.gdk_pixbuf_sys."0.4.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.gio_sys."0.4.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.glib."0.3.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.glib_sys."0.4.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.gobject_sys."0.4.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.log."0.3.9" = deps: f: updateFeatures f (
    rec {
  ...
  features_.ordermap."0.3.5" = deps: f: updateFeatures f (
    rec {
  ...
  features_.petgraph."0.4.13" = deps: f: updateFeatures f (
    rec {
  ...
  features_.phf."0.7.23" = deps: f: updateFeatures f (
    rec {
  ...
  features_.rand."0.3.22" = deps: f: updateFeatures f (
    rec {
  ...
  crates.rand."0.5.5" = deps: { features ? (features_.rand."0.5.5" deps {}) }: buildRustCrate {
    ...
    ++ (
         if kernel == "cloudabi" then mapFeatures features (
           []
           ++ (if features.rand."0.5.5".cloudabi or false then [ (crates.cloudabi."${deps."rand"."0.5.5".cloudabi}" deps) ] else [])
         ) else []
       )
    ++ (
         if kernel == "fuchsia" then mapFeatures features (
           []
           ++ (if features.rand."0.5.5".fuchsia-zircon or false then [ (crates.fuchsia_zircon."${deps."rand"."0.5.5".fuchsia_zircon}" deps) ] else [])
         ) else []
       )
    ++ (
         if (kernel == "linux" || kernel == "darwin") then mapFeatures features (
           []
           ++ (if features.rand."0.5.5".libc or false then [ (crates.libc."${deps."rand"."0.5.5".libc}" deps) ] else [])
         ) else []
       )
    ++ (
         if kernel == "windows" then mapFeatures features (
           []
           ++ (if features.rand."0.5.5".winapi or false then [ (crates.winapi."${deps."rand"."0.5.5".winapi}" deps) ] else [])
         ) else []
       )
    ++ (
  ...
  features_.rlua."0.9.7" = deps: f: updateFeatures f (
    rec {
  ...
  features_.rustwlc."0.7.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.serde."0.9.15" = deps: f: updateFeatures f (
    rec {
  ...
  features_.serde_json."0.9.10" = deps: f: updateFeatures f (
    rec {
  ...
  features_.target_build_utils."0.3.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.uuid."0.3.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.way_cooler."0.8.1" = deps: f: updateFeatures f (
    rec {
  ...
  features_.wayland_server."0.12.5" = deps: f: updateFeatures f (
    rec {
  ...
  features_.wayland_sys."0.6.0" = deps: f: updateFeatures f (
    rec {
  ...
  features_.wayland_sys."0.9.10" = deps: f: updateFeatures f (
    rec {
      dlib = fold recursiveUpdate {} [
        {
  ...
  features_.wayland_sys."0.12.5" = deps: f: updateFeatures f (
    rec {
      dlib = fold recursiveUpdate {} [
        {
  ...
  features_.xcb."0.8.2" = deps: f: updateFeatures f (
    rec {
